...
.. figure:: ../../../analyses/samples/IDWR/Text.png
   :width: 95%
   :align: center
   :figwidth: 95%

   `IDWR sample image <http://s3-eu-west-1.amazonaws.com/textract.samples/idwr1893-v1_0021.jpg>`_, alongside the word blocks produced by Textract. Red and blue chequerboard patterns show tables Textract has found on the page.

...
# Make a documentation page for one month's Textract results from the 
...
with open(opfile,"w") as f:
    f.write(":orphan:\n\n")
    f.write("Textract results for the OCR-weatherrescue benchmark %04d-%02d\n" % (
              args.year,args.month))
    f.write("=============================================================\n\n")
    f.write(".. figure:: ../../../analyses/OCR-weatherrescue/%04d-%02d.png\n" % (
            ...
            "   :align: center\n" +
            "   :figwidth: 95%\n\n" +
            "   Textract results for `this month in the benchmark "+
            " <http://brohan.org/OCR-weatherrescue/individual_months/1903-11.html>`_. "+
            "Green blocks are entries sucessfully read by Textract. " +
